RegisterCommand("testnpc", function()
    ...
    local npc = exports['rep-talkNPC2']:CreateNPC({
        npc = 'u_m_y_abner',
        ...
        [1] = {
            ...
            shouldClose = false,
            action = function()
                exports['rep-talkNPC2']:updateMessage("It is a team that creates scripts for FiveM")
            end
        },
        [2] = {
            ...
            shouldClose = false,
            action = function()
                exports['rep-talkNPC2']:changeDialog("We have clean and dirty jobs, which one do you want to choose?",
                    {
                        [1] = {
                            label = "Clean jobs",
                            shouldClose = true,
...
-- function CreatePeds()
--         Boss = exports['rep-talkNPC2']:CreateNPC({
--             npc = 's_m_y_garbage',
...
--                 shouldClose = false,
--                 action = function()
--                     exports['rep-talkNPC2']:changeDialog({
...
--                                             exports['rep-talkNPC2']:updateMessage(
...
--                                         end
--                                     else
--                                         exports['rep-talkNPC2']:updateMessage("You already have this job")
--                                     end
--                                 end
--                             },
--                             [2] = {
...
--                 action = function()
--                     if onDuty == true then
--                         exports['rep-talkNPC2']:updateMessage("It's sad to say goodbye to you")
--                         Wait(2000)
